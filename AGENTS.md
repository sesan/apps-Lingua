...
Wherever you used the stylesheet to style the specific components that that support Tailwind and NativeWind class names remove the stylesheet styles and turn it into class name styles.
